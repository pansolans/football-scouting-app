...
class SupabaseService:
    def __init__(self):
        ...
        try:
            ...
            logger.info("[OK]Cliente Supabase creado exitosamente")
        except Exception as e:
            logger.error(f"[ERROR]Error creando cliente Supabase: {e}")
            raise
    ...
    def create_report(self, report_data: dict) -> dict:
        ...
        try:
            ...
            logger.info(f"[OK]Reporte guardado exitosamente")
            return response.data[0] if response.data else None
        except Exception as e:
            logger.error(f"[ERROR]Error guardando en Supabase: {str(e)}")
            raise
